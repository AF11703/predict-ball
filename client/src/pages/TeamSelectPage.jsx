...
const TeamSelectPage = () => {
  ...
  return(
    <div className="flex flex-col bg-linear-210 from-gray-950 to-cyan-400 border border-cyan-600/55 shadow-2xl shadow-cyan-400 drop-shadow-teal-300/40 drop-shadow-xs rounded-2xl items-center justify-center gap-6 md:gap-12 px-4 py-8 my-40">
